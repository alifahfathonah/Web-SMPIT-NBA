...
<body>
    ...
    <!--============================= HEADER =============================-->
            ...
            <?php $this->load->view('depan/slider'); ?>
    <!--//END HEADER -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8">
               ...
               <p>Kami Menyambut baik terbitnya Website SMPIT NURBAROKAH AL-WADANI yang baru, dengan harapan dipublikasinya website ini sekolah berharap : Peningkatan layanan pendidikan kepada siswa, orangtua, dan masyarakat pada umumnya semakin meningkat. </p>
